...
```{r Gene expression Analysis pt1}
...
```{r Gene expression Analysis pt2}
## 2. Add mean column
...
```{r Gene expression Analysis pt3}
...
```{r Gene expression Analysis pt4}
...
```{r Gene expression Analysis pt5}
...
mean_expression <- rowMeans(gene)

# Subset values below 100
mean_expression_sub <- mean_expression[mean_expression < 100]

# Plot histogram
hist(mean_expression_sub,
     breaks = 50,
     main = "Histogram of mean gene expression (<100)",
